...
Source scene + animation: dev/icon/build_scene.js -> dev/icon/enchanted_veinminer_icon_anim.bbmodel (Aseprite textures from dev/icon/draw_sprites.lua).
...
PALETTE = 255
CROP_PCT = 0.90
EXTRA_FRAMES = (35, 36, 37)  # the backswing and strike: brief, but must stay fully in frame
CROP_MARGIN = 1.08
OUTLINE = 19
PACK_MARGIN = 1.12
